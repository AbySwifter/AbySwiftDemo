...
class ABYTabBarComtroller: UITabBarController {
	...
	func addChildViewControllers() -> Void {
		addChildViewController(childController: ConversationViewController(), title: "会话", icon: #imageLiteral(resourceName: "tab_conversation_no"), selectedIcon: #imageLiteral(resourceName: "tab_conversation"))
		addChildViewController(childController: FormsViewController(), title: "报表", icon: #imageLiteral(resourceName: "tab_form"), selectedIcon: #imageLiteral(resourceName: "tab_form_selected"))
		addChildViewController(childController: MineViewController(), title: "我的", icon: #imageLiteral(resourceName: "tab_my"), selectedIcon: #imageLiteral(resourceName: "tab_my_selected"))
	}
	/**
	# 初始化子控制器
